...
+ median_income + ocean_proximity, data=train, method="anova") 
...
#accuracy within 10%
accuracy10<- ifelse(abs(test$median_house_value-P_median_house_value)
                    <0.10*test$median_house_value,1,0) 
print(mean(accuracy10))

#accuracy within 15%
accuracy15<- ifelse(abs(test$median_house_value-P_median_house_value)
                    <0.15*test$median_house_value,1,0)
print(mean(accuracy15))

#accuracy within 20%
accuracy20<- ifelse(abs(test$median_house_value-P_median_house_value)
                    <0.20*test$median_house_value,1,0)
